  ...
  ?>
      ...
      <div class='Div1 BG_Vert'>
        ...
        <div class='Div1 BG_Vert'>
          ...
          <!-- Totaux -->
          <?php 
            $test = new PDO('mysql:host=mysql-lapro.alwaysdata.net;dbname=lapro_virus', $user, $pass);
          ?>
          <p class='TC'>Nombre d'item <b>Totaux</b> : <?= getNombreItem($test);  ?>.</p>
          <!-- LV -->
          <?php
          for ($i = 1; $i < 4; $i++) {
          ?>
        ...
        <div class='Div1 BG_Vert'>
          ...
          <!-- Totaux -->
          <p class='TC'>Nombre d'équipement <b>Totaux</b> : <?= getNombreEquipement($mabase); ?>.</p>
          <!-- LV -->
          <?php
          for ($i = 1; $i < 4; $i++) {
          ?>
...
function getNombreItem($bdd)
{
  ...
  $excuteReq = $bdd->query("SELECT COUNT(*) as 'NB' FROM `item`");
